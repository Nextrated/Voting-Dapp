      ...
      >
          ...
          <Box onClick={onSetVotingOpen} cursor="pointer">
            ...
            >
              ...
              <Stack>
                ...
                <Text color={"gray.500"}>
                  The vote cordinator has the power to set voting for who is
                  eligible to show interest in this particular election.
                </Text>
              </Stack>
            </Box>
          </Box>
          ...
          <Box onClick={onShowInterestOpen} cursor="pointer">
            ...
            >
              ...
              <Stack>
                ...
                <Text color={"gray.500"}>
                  The vote cordinator sets the time for the contestants to show
                  interest in a particular election.{" "}
                </Text>
              </Stack>
            </Box>
          </Box>
            ...
            <ModalContent>
              ...
              <ModalBody pb={6}>
                <form action="" onSubmit={setContestTime}>
                  <FormLabel>Enter the time</FormLabel>
                  <Input
                    type="number"
                    onChange={handleTime}
                    min="0"
          ...
          <Box onClick={onSetTimeOpen} cursor="pointer">
            ...
            >
              ...
              <Stack>
                ...
                <Text color={"gray.500"}>
                  The vote cordinator has the power to set the time span of how
                  long he wants voting to last.{" "}
                </Text>
              </Stack>
            </Box>
          </Box>
        ...
        <GridItem>
          <Box onClick={onResetOpen} cursor="pointer">
            ...
            >
              ...
              <Stack>
                ...
                <Text color={"gray.500"}>
                  The vote cordinator has the power to reset the categories to
                  be voted for and roles eligible to contest{" "}
                </Text>
              </Stack>
            </Box>
          </Box>
          ...
          >
            <ModalOverlay />
            <ModalContent>
              <ModalHeader mt="5">Reset Election</ModalHeader>
              <ModalCloseButton />
              <ModalBody pb={6}>
